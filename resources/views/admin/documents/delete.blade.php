<!-- Modal -->
<div class="modal fade" id="delete-document{{ $document->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <img src="{{ url('storage/' . $document->user()->first()->cover) }}" class="rounded img-fluid" width="40">

                        @else
                        <img src="{{ url('assets/background/avatar.png') }}" class="rounded img-fluid" width="40">
                        @endif						
                        <p class="text-muted">Apagar documento de {{ $document->user()->first()->name }}</p>
