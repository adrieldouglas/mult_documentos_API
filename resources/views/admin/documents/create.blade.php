<div class="modal fade" id="add-document" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="{{ route('admin.documents.store') }}" method="POST">
        ...
        <div class="modal-dialog modal-lg">  
            <div class="modal-content">
                <div class="modal-header" style="background-color: #E0D9BF;">
                    <h5 class="modal-title">Novo Dcumento</h5>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="document_rg" class="form-control {{ $errors->has('document_rg') ? 'is-invalid' : '' }}" placeholder="__.___.___-_" data-mask="00.000.000-0" value="{{ old('document_rg') }}">
        ...
        <div class="row">
          <div class="col-sm-4">
              ...
              <input type="text" name="document_cnh" class="form-control {{ $errors->has('document_cnh') ? 'is-invalid' : '' }}" placeholder="___________" data-mask="00000000000" value="{{ old('document_cnh') }}">
        ...
        <div class="col-sm-4">
            ...
            <input type="text" name="document_cnpj" class="form-control {{ $errors->has('document_cnpj') ? 'is-invalid' : '' }}" placeholder="__.___.___/____-__" data-mask="00.000.000/0000-00" value="{{ old('document_cnpj') }}">
        ...
        <div class="col-sm-4">
            ...
            <input type="text" name="zipcode" class="form-control  {{ $errors->has('zipcode') ? 'is-invalid' : '' }}" placeholder="_____-___" data-mask="00000-000" value="{{ old('zipcode') }}">
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <input type="text" name="voter_registration" class="form-control {{ $errors->has('voter_registration') ? 'is-invalid' : '' }}" placeholder="____________" data-mask="000000000000" value="{{ old('voter_registration') }}">
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn" style="background-color: #E0D9BF;"><i class="bi bi-check2-square"></i> Salvar</button>
</div>
</div>
</div>	
</form>	
